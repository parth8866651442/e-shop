...
$(document).ready(function(){
    ...
    jQuery.validator.addMethod("notEqualTo", function(value, element)
       ...
       {
           var response;
           var post_url_check_username = baseurl + "admin/user/checkUsernameExist/";
       ...
       jQuery.validator.addMethod("checkMobileExist", function(value, element)
       {
           ...
           var post_url_check_mobile = baseurl + "admin/user/checkMobileExist/";
       ...
       jQuery.validator.addMethod("checkMobileExist2", function(value, element)
       {
           ...
           var post_url_check_mobile2 = baseurl + "admin/user/checkMobileExist2/";
       ...
       jQuery.validator.addMethod("checkPhoneExist", function(value, element)
       {
           ...
           var post_url_check_phone = baseurl +"admin/user/checkPhoneExist/";
	   ...
	   {			
			...
			var post_url_check_phone = baseurl +"admin/profile/checkMobileExist1Same/";
		...
		jQuery.validator.addMethod('checkMobileExist2Same', function(value, element)
		{
			...
			var post_url_check_mobile2 = baseurl + "admin/profile/checkMobileExist2Same/";
		...
		jQuery.validator.addMethod('checkPhoneExistSame', function(value, element)
		{
			...
			var post_url_check_mobile2 = baseurl + "admin/profile/checkPhoneExistSame/";
  ...
  jQuery.validator.addMethod("checkEmailExistFranchise", function(value, element)
       {
           ...
           var post_url_check_email_franchise = baseurl +"admin/franchise/franchise/checkEmailExist/";
   ...
   jQuery.validator.addMethod("checkroles", function(value, elem, param) {
