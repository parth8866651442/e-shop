                ...
                <div class="col-lg-6">
                    <form method="POST" action="{{ route('password.update') }}" id="registerForm">
                        ...
                        <div class="new-customers">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <input type="email" class="custom-form" name="email" id="email" placeholder="Email Address" value="{{ $email ?? old('email') }}" required readonly />
                                </div>
                                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="submit" class="custom-form custom-submit no-margin mb-0" value="Reset Password" />
                                </div>
                            </div>
                        </div>
                    </form>
