                        ...
                        <div class="sidebar-product">
                            ...
                            <div class="single-product">
                                <div class="product-photo">
                                    <a href="#">
                                        <img class="primary-photo" src="{{asset('assets/img/sidebar/1.png')}}" alt="" />
                                    </a>
                                </div>
                            ...
                            <div class="single-product">
                                <div class="product-photo">
                                    <a href="#">
                                        <img class="primary-photo" src="{{asset('assets/img/sidebar/2.png')}}" alt="" />
                                    </a>
                                </div>
                                <div class="product-brief">
                            ...
                            <div class="single-product">
                                <div class="product-photo">
                                    <a href="#">
                                        <img class="primary-photo" src="{{asset('assets/img/sidebar/3.png')}}" alt="" />
                                    </a>
                                </div>
                                <div class="product-brief">
                            ...
                            <div class="single-product">
                                <div class="product-photo">
                                    <a href="#">
                                        <img class="primary-photo" src="{{asset('assets/img/sidebar/4.png')}}" alt="" />
                                    </a>
                                </div>
                                <div class="product-brief">
                            ...
                            <div class="single-product">
                                <div class="product-photo">
                                    <a href="#">
                                        <img class="primary-photo" src="{{asset('assets/img/sidebar/5.png')}}" alt="" />
                                    </a>
                                </div>
                                <div class="product-brief">
